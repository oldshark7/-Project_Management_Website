    ...
    <div class="px-4 py-2">
        ...
        <div class="bg-white border border-slate-100 shadow-sm rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
            ...
            <div class="flex items-center gap-2 text-xs">
                ...
                <span class="text-slate-800 font-bold">Ubah Item WBS</span>
            </div>
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mb-6">
                ...
                <p class="text-xs text-slate-500 mt-1">Ubah detail rincian pekerjaan atau tingkat hierarki tugas di bawah ini.</p>
            </div>
