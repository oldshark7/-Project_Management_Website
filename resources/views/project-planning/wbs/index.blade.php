    ...
    <div class="px-4 py-2">
        ...
        <div class="bg-white border border-slate-100 shadow-sm rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
            ...
            <div class="flex items-center gap-2 text-xs">
                ...
                <span class="text-slate-800 font-bold">WBS Management</span>
            </div>
        ...
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl font-black text-slate-800 tracking-tight">{{ __('WBS Management') }}</h2>
                                            ...
                                            @if($isScopeFinalized)
                                                @if($wbsStatus === 'none')
                                                    @if($userRole === 'pmo' || $userRole === 'project management officer')
                                                        <a href="{{ route('projects.wbs.create', $project->id) }}" class="inline-flex items-center px-3.5 py-2 text-[10px] font-bold text-blue-600 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-600 hover:text-white shadow-sm transition">
                                                    ...
                                                    @endif
                                                @else
                                                    <a href="{{ route('projects.wbs.show', $project->id) }}" class="inline-flex items-center px-3.5 py-2 text-[10px] font-bold text-slate-700 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 hover:text-slate-900 shadow-sm transition">
